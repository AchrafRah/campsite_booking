...
public class BookingService {
     ...
     */
    private List<Availability> getBookings(LocalDate arrivalDate, LocalDate departureDate) {
        if (arrivalDate == null) {
    ...
    public void deleteReservation(String requestId) {
        ...
        reservationEntity.setCampsiteBooking(null);
        reservationEntity.setCampsiteBooking(null);
    ...
    private ReservationEntity getReservationEntity(String requestId) {
        ...
        if (!reservationEntity.isActive()) {
            throw new ResponseStatusException(
                    HttpStatus.FORBIDDEN, "This booking id is archived: " + requestId);
        }
